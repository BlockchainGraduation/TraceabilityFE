...
export default function TransactionSelectItem(props: PropsType) {
  ...
  return (
    <div
      ...
      className="flex w-full group flex-col p-[20px] hover:bg-[#ececec] rounded-xl transition-all duration-500 transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none"
    >
      ...
      {showButton && (
        <Button
          ...
          className="m-auto mt-[10px] w-2/3 group-hover:transition-all group-hover:duration-500 group-hover:delay-300 group-hover:transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none"
        >
          Chọn
        </Button>
      )}
