...
export default function GrowUpItem() {
  return (
    <div className="flex items-center py-[50px] translate-y-[50%] ">
      <div
        className={`relative pl-[100px] before:content-[''] before:absolute before:rounded-[50%] before:left-[0px] before:top-1/2 before:translate-y-[-50%] before:w-[30px] before:h-[30px] before:bg-teal-200 after:content-[''] after:absolute after:z-[-1] after:left-0 after:top-1/2 after:translate-y-[-50%]  after:w-[120%] after:h-[2px] after:bg-[#0505050f]`}
      >
      ...
      <p className="p-[50px] w-[700px] bg-inherit">
